...
\begin{align}
    ...
    e_i \leq \tau_i                             \label{subeq:valid_depart} \\
...
ensures that the time the BEB is detatched from the charger, $e_i$, is before its departure time, $\tau_i$.
...
the slack variable $g_{iq}$ to be equal to $s_i w_{iq}$, $g_{iq}$ can be defined as
...
\end{equation}
\begin{equation}
    s_i + u_i = e_i                                  \label{subeq:m_detach}       \\
\end{equation}
\begin{equation}
...
\end{equation}
\begin{equation}
    e_i \leq \tau_i                                        \label{subeq:m_valid_depart} \\
\end{equation}
\begin{equation}
