...
% Docmument version
%
% This section includes the date as well as the document verion being read. The
% document version is extracted from the git tag associated with the commit
% that the current document is being compiled from.
%
