...
which can be a valid assumption when the battery state-of-charge (SOC) is below 80$\backslash$% charge
...
\% LINKS:
\%
\% \url{https://github.com/maxbw117/DevelopmentPerSecond/blob/master/Tikz-pgfplots-and-latex/Tutorial\%202-\%20Figures\%20and\%20Large\%20File\%20Organization/Figures\%20Chapter\%201/01\%20Ocean\%20and\%20Model\%20Scale.tex}
\% \url{https://www.overleaf.com/learn/latex/Questions/I\_have\_a\_lot\_of\_tikz\%2C\_matlab2tikz\_or\_pgfplots\_figures\%2C\_so\_I\%27m\_getting\_a\_compilation\_timeout.\_Can\_I\_externalise\_my\_figures\%3F}
\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%
