...
\textcolor{blue}{an SOC of $\alpha_i = $} \fpeval{\acharge*100}\% \textcolor{blue}{$\forall i \in \mathbb{V}$}
(\fpeval{\acharge * \batsize} kWh). Additionally, each bus is required to end the day with a minimum
\textcolor{blue}{ SOC of $\beta_i = $}\fpeval{\bcharge * 100}\% (\fpeval{\bcharge * \batsize} kWh)
