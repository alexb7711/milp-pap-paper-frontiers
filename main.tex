...
assumed to begin the working day with an SOC of \$\(\alpha\)\textsubscript{b} = \$ \fpeval{\acharge*100}\% \(\forall i \in \mathbb{V}\)
...
Qin-Modified schedule, on the other hand, allowed the SOC of certain BEBs to drop to 0$\backslash$%.
