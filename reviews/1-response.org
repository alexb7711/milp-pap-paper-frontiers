...
\begin{quote}
\textcolor{blue}{We appreciate your feedback. An effort to explain these critical assumptions are presented in the introductory paragraphs of Section - The assumptions listed are: discharge calculation and that the difference of SOC at the end of the working day can reach the assumed inital SOC for the next day.}
\end{quote}
